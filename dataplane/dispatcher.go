// Package dataplane adapts stable go-queue management contracts without
...
var (
	...
	// ErrUnsupportedCommand reports a command outside go-queue management.
...
// ControllerResolver selects a tenant-scoped go-queue management controller.
...
// go-queue management envelope and preserves honest terminal outcomes.
...
// DispatchResult executes through a tenant-scoped go-queue Controller.
