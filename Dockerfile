...
LABEL org.opencontainers.image.title="go-queue-control" \
      org.opencontainers.image.description="Administrative CLI for go-queue-control-plane" \
...
LABEL org.opencontainers.image.title="go-queue-control-plane" \
      org.opencontainers.image.description="Operational control plane for go-queue" \
      org.opencontainers.image.source="https://github.com/faustbrian/go-queue-control-plane" \
      org.opencontainers.image.version="${VERSION}" \
      org.opencontainers.image.revision="${COMMIT}" \
      org.opencontainers.image.created="${BUILT_AT}" \
