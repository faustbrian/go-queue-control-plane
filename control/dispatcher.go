...
var (
	...
	// ErrDataPlaneUnavailable reports that no go-queue controller is reachable.
...
// RoutingDispatcher keeps Kubernetes scaling separate from go-queue control
// commands.
...
// DispatchResult preserves structured go-queue acknowledgements while
