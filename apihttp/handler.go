...
// RecordSource reads tenant-scoped go-queue failures and dead letters.
...
// QueueSource reads tenant-scoped go-queue status pages.
...
// TelemetryConfig supplies standard OpenTelemetry APIs owned by go-telemetry.
