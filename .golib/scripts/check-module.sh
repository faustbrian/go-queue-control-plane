...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-queue-control-plane" &&
                "${module_path}" != github.com/faustbrian/go-queue-control-plane/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-queue-control-plane"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
